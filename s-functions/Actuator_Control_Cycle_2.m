function [sys, x0, str, ts] = Actuator_Control_Cycle_2(t, x, u, flag, AGV_2, Rack_RFID)
...
switch flag
    ...
    case 3
        sys = mdlOutputs(t, x, u, Rack_RFID, AGV_2);
    ...
    function sys = mdlOutputs(t, x, u, Rack_RFID, AGV_2)
        lift = u(1);
        numrfid = u(2);              
        data1 = get_param(gcb, 'UserData');
        global AGV_2 Rack_RFID; 
        data1.Start = AGV_2.Start; 
        data1.Target = AGV_2.Target;
        data1.AGVState = AGV_2.AGVState;
        ...
        AGV_2.AGVState = data1.AGVState;
        AGV_2.Start = data1.Start;
        AGV_2.Target = data1.Target;
        AGV_2.AGVState = data1.AGVState;
