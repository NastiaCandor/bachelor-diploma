%---------------------------------------------------------
function [sys, x0, str, ts] = Control_system_2(t, x, u, flag, lns, pnts) %The last one is the end of the grinding

switch flag
    case 0
        [sys, x0, str, ts] = mdlInitializeSizes;
        initdata.Path = [1    63     6    42    77     5];%[1    63    70    69    68    67     2    49    66    72    48    64    34    32    30     9    18];
        ...
        initdata.TypeIntersection = 0; % 0 normal, 1 t-shaped, 2 - turn
        ...
        if all(data.State == 'flw')
            ...
            if (detectrfid > 0)
                ...
                if (numrfid ~= 1) 
                    ...
                    for i = 1 : 4
                        if (solver(i) == 0)
                           data.TypeIntersection =  data.TypeIntersection + 1;
                        end;
                    end;
