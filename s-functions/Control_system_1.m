%---------------------------------------------------------
function [sys, x0, str, ts] = Control_system_1(t, x, u, flag, lns, pnts) %The last one is the end of the grinding

switch flag
    case 0
        [sys, x0, str, ts] = mdlInitializeSizes;
        initdata.Path = [29  25  45   50  36  33  26  27  34  37  38  35   28];%[29  25  26   33  36  37  38  35  28]];
        initdata.NavigationPoints = Navigation_1(pnts, lns);
        initdata.PrevRfid = 29;
        initdata.Counter = 2;
