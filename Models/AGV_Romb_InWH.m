...
ADAMS_exec = '' ;
ADAMS_host = 'CAD-sPC' ;
ADAMS_cwd ='C:\Users\CAD_Admin\AGV 1 computer\AGV_v_0_1'  ;
ADAMS_prefix = 'AGV_Romb_InWH' ;
ADAMS_static = 'no' ;
ADAMS_solver_type = 'C++' ;
...
ADAMS_init = '' ;
ADAMS_inputs  = 'SEVelLeft!SEVelRight' ;
ADAMS_outputs = 'SESensorCLX!SESensorCLY!SESensorCX!SESensorCY!SESensorCRX!SESensorCRY!SESensorRFIDX!SESensorRFIDY' ;
ADAMS_pinput = 'AGV_Romb_InWH.ctrl_pinput' ;
ADAMS_poutput = 'AGV_Romb_InWH.ctrl_poutput' ;
ADAMS_uy_ids  = [
                   171
                   170
                   176
